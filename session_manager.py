...
def generate_session_urls(session_code: str, base_url: str = "https://your-app.streamlit.app") -> Dict[str, str]:
...
def display_session_qr_code(session_code: str, base_url: str = "https://your-app.streamlit.app"):
    ...
    with col2:
        ...
        if st.button("📋 Copy Subject URL", help="Copy URL to clipboard"):
