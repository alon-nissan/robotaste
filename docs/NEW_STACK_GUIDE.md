...
You need **two terminals** to run the new stack:
...
- `--ws none` = disables WebSocket support (avoids a library conflict)
...
- Open this URL in your browser to see the new UI
