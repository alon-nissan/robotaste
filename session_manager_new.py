...
def sync_session_state(session_id: str, role: str) -> bool:
    ...
    try:
        ...
        if experiment_config:
            ...
            st.session_state.interface_type = experiment_config.get("interface_type")
            st.session_state.num_ingredients = experiment_config.get("num_ingredients")
            st.session_state.method = experiment_config.get("method")
            st.session_state.ingredients = experiment_config.get("ingredients")
            st.session_state.questionnaire_type = session_info.get("questionnaire_name")
            st.session_state.moderator_name = experiment_config.get("moderator_name")
            st.session_state.current_phase = session_info.get("current_phase", "waiting")
